<section class="small-banner-block layout-xl">
    <?php
    ...
    ?>
    <div class="small-banner-block__content">
        ...
        ?>
            <a class="small-banner-block__content-button button--light" href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><?php echo esc_html($link_title); ?></a>
        <?php endif; ?>
    ...
    ?>
        ...
        <picture>
            ...
            <img
                class="small-banner-block-background"
