...
$text = get_field('text');
$media_left = get_field('media_left_or_right');
?>

<section class="text-image-block<?php echo $media_left ? ' text-image-block--media-left' : ''; ?>">
    <div class="text-image-block__inner layout-xl">
