...
<div class="content-controls">
    <div class="content-controls__wrapper">
        <button class="content-controls__button content-controls__button--prev content-controls-prev" aria-label="<?php _e('Previous', 'keweb'); ?>" <?php echo $slider_id_attr; ?>>
        ...
        <button class="content-controls__button content-controls__button--next content-controls-next" aria-label="<?php _e('Next', 'keweb'); ?>" <?php echo $slider_id_attr; ?>>
