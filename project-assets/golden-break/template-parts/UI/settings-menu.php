<ul class="settings-menu common-menu">
    <li class="settings">
        <button class="settings__toggle common-menu__toggle" aria-haspopup="true" aria-expanded="false" aria-label="<?php _e('Open settings menu', 'keweb'); ?>">
